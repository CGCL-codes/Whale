 ...
 * storm jar didiStockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.MulticastModelBalancedParitalBenchTopology MulticastBenchTopology ordersTopic6 31 1 480 2 netty 1000
 * storm jar benchmark-stockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.stockdeal.StockDealBalancedPartialBenchTopology \
 StockDeal stockTopic6 24 1 384 3 rdma 1
 */
public class StockDealBalancedPartialBenchTopology {
...
//        builder.setSpout(KAFKA_SPOUT_ID, new StockDealKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic)), spoutInstancesNum);
        ...
        builder.setBolt(BENCH_BOLT_ID, new BenchReportBolt(),1).shuffleGrouping(elementBolt, LATENCY_STREAM_ID)
