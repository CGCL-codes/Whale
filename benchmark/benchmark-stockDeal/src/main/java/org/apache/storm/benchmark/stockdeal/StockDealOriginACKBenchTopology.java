...
import org.apache.storm.benchmark.spout.StockDealPossionKafkaSpout;
 ...
 * storm jar benchmark-didiStockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.didimatch.DiDiStockDealOriginACKBenchTopology DiDiStockDealTopology ordersTopic 24 1 23 100000 netty 1
 */
public class StockDealOriginACKBenchTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOUT_ID, new StockDealPossionKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic), possionExpect), spoutInstancesNum);
        builder.setBolt(DIDIMATCH_BOLT_ID, new StockDealBolt(),boltInstancesNum).allGrouping(KAFKA_SPOUT_ID,SPOUT_STREAM_ID);
        builder.setBolt(STOCKDEAL_BOLT_ID,new BenchReportBolt()).shuffleGrouping(KAFKA_SPOUT_ID,LATENCY_STREAM_ID)
...
//                new Fields("topic", "partition", "offset", "key", "value"), TOPIC_2_STREAM);
        return KafkaSpoutConfig.builder(bootstrapServers, new String[]{topic})
                .setProp(ConsumerConfig.GROUP_ID_CONFIG, "DiDiStockDealBenchGroup")
