 ...
 * storm jar didiStockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiStockDealOriginACKThroughputTopology DiDiStockDealLatencyTopology ordersTopic 30 1 30 30
 * storm jar didiStockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiStockDealOriginACKThroughputTopology DiDiStockDealLatencyTopology ordersTopic 7 1 120 1
 */
public class StockDealOriginACKThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setBolt(THROUGHPUT_BOLT_ID,new ThroughputReportBolt()).shuffleGrouping(KAFKA_SPOUT_ID,THROUGHPUT_STREAM_ID);
