...
import org.apache.storm.benchmark.bolt.StockDealLatencyBolt;
import org.apache.storm.benchmark.spout.StockDealKafkaSpout;
 ...
 * storm jar didiStockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.MulticastModelBalancedParitalLatencyTopology MulticastLatencyTopology ordersTopic6 31 1 480 2 netty 1000
 * storm jar didiStockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.MulticastModelBalancedParitalLatencyTopology MulticastLatencyTopology ordersTopic 7 1 28 2 rdma 1000
 */
public class StockDealBinomialTreeLatencyTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOUT_ID, new StockDealKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic)), spoutInstancesNum);
        graph = builder.constructionBinomialTree(boltInstancesNum, numworkers - 1,
                KAFKA_SPOUT_ID, SPOUT_STREAM_ID, BROADCAST_STREAM_ID, StockDealLatencyBolt.class);
