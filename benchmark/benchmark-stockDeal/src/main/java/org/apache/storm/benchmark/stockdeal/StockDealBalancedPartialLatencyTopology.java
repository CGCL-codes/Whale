 ...
 * storm jar benchmark-stockDeal-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.stockdeal.StockDealBalancedPartialLatencyTopology \
      MulticastLatencyTopology stockTopic6 25 1 400 2 rdma 1000
 */
public class StockDealBalancedPartialLatencyTopology {
...
//        builder.setSpout(KAFKA_SPOUT_ID, new OrderMatchKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic)), spoutInstancesNum);
        ...
        builder.setBolt(LATENCY_BOLT_ID, new LatencyReportBolt(), 1).shuffleGrouping(elementBolt, Constraints.LATENCY_STREAM_ID)
                .shuffleGrouping(elementBolt, Constraints.LATENCY_STREAM_ID);
