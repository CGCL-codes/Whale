 ...
 */
public class StockDealThroughputBolt extends BenchThroughputBolt {
    private static Logger logger= LoggerFactory.getLogger(StockDealThroughputBolt.class);
    ...
    public StockDealThroughputBolt() {
        super( 1000);
    }
