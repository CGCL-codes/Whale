 ...
 * 重写KafkaSpout
 */
public class MulticastPossionKafkaSpout<K, V> extends KafkaPoissonSpout<K, V> {
    private int thisTaskId =0;

    public MulticastPossionKafkaSpout(KafkaSpoutConfig<K, V> kafkaSpoutConfig, int expect) {
