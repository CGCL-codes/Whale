 ...
 * storm jar benchmark-didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.didimatch.DiDiOrderMatchBalancedPartialThroughputTopology \
 MulticastThroughputTopology ordersTopic6-3 25 1 400 3 rdma 1
 */
public class DiDiOrderMatchBalancedPartialThroughputTopology {
...
//        builder.setSpout(KAFKA_SPOUT_ID, new OrderMatchKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic)), spoutInstancesNum);
        graph = builder.constructionBalancedPartialMulticast(boltInstancesNum, numWorkers - 1, maxOutDegree,
                KAFKA_SPOUT_ID, SPOUT_STREAM_ID, BROADCAST_STREAM_ID, OrderMatchThroughputBolt.class);
