 ...
 * DiDi滴滴打车订单匹配Topology
 storm jar benchmark-didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.didimatch.DiDiOrderMatchOriginACKLatencyTopology MulticastThroughputTopology ordersTopic6 18 1 17 1 rdma 300
 */
public class DiDiOrderMatchOriginACKLatencyTopology {
...
//                new Fields("topic", "partition", "offset", "key", "value"), TOPIC_2_STREAM);
        return KafkaSpoutConfig.builder(bootstrapServers, new String[]{topic})
                .setProp(ConsumerConfig.GROUP_ID_CONFIG, "DiDiOrderMatchLatencyGroup")
