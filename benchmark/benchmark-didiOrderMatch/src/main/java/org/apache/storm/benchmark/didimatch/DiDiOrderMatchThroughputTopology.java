...
import org.apache.storm.benchmark.spout.OrderMatchThroughputKafkaSpout;
 ...
 * DiDi滴滴打车订单匹配Topology
 storm jar benchmark-didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.didimatch.DiDiOrderMatchThroughputTopology MulticastThroughputTopology ordersTopic6 29 1 464
 */
public class DiDiOrderMatchThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOUT_ID, new OrderMatchThroughputKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER,topic)), spoutInstancesNum);
        builder.setBolt(DIDIMATCH_BOLT_ID, new OrderMatchBolt(),boltInstancesNum).allGrouping(KAFKA_SPOUT_ID,SPOUT_STREAM_ID);
        builder.setBolt(THROUGHPUT_BOLT_ID, new ThroughputReportBolt(),1).shuffleGrouping(KAFKA_SPOUT_ID,THROUGHPUT_STREAM_ID);
