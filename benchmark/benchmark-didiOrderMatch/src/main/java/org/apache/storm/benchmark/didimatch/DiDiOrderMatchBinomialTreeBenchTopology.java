 ...
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.MulticastModelBalancedParitalBenchTopology MulticastBenchTopology ordersTopic6 31 1 480 2 netty 1000
 * storm jar benchmark-didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.didimatch.DiDiOrderMatchBinomialTreeBenchTopology \
 MulticastBenchTopology ordersTopic6-3 25 1 400 rdma 1
 */
public class DiDiOrderMatchBinomialTreeBenchTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOUT_ID, new OrderMatchPossionKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic), 120000), spoutInstancesNum);
