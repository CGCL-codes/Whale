 ...
 * storm jar benchmark-didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.didimatch.DiDiOrderMatchSequentialLatencyTopology \
MulticastLatencyTopology ordersTopic6 17 1 272 rdma 1 60000
 */
public class DiDiOrderMatchSequentialLatencyTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String transport = args[5]; //论文中的Wait Time Limitation参数
...
//        builder.setSpout(KAFKA_SPOUT_ID, new OrderMatchKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic)), spoutInstancesNum);
        graph = builder.constructionSequential(boltInstancesNum, numworkers - 1,
                KAFKA_SPOUT_ID, SPOUT_STREAM_ID, OrderMatchLatencyBolt.class);
