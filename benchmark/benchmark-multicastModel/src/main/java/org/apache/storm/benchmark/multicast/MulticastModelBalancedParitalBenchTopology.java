 ...
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelBalancedParitalBenchTopology MulticastBenchTopology ordersTopic 26 1 25 10 100000 rdma 1
 * 平均吞吐量 30 4 64027.0426 (并行度 最大出度 吞吐量)
 */
public class MulticastModelBalancedParitalBenchTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        graph = builder.constructionBalancedPartialMulticast(boltInstancesNum, numworkers - 1, maxOutDegree,
                KAFKA_SPOUT_ID, SPOUT_STREAM_ID, BROADCAST_STREAM_ID, MulticastBenchBolt.class);
