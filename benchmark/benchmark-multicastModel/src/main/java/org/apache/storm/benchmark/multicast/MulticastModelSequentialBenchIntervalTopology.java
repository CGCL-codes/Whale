...
import org.apache.storm.benchmark.spout.MulticastPossionIntervalKafkaSpout;
 ...
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelSequentialBenchIntervalTopology MulticastBenchTopology ordersTopic 26 1 25 100000 rdma 1
 * 平均吞吐量 30 84331.9571 (并行度 吞吐量) 平均延迟 30 16.54958333333333
 */
public class MulticastModelSequentialBenchIntervalTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOUT_ID, new MulticastPossionIntervalKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic), possionExpect), spoutInstancesNum);
        graph = builder.constructionSequential(boltInstancesNum, numworkers - 1, KAFKA_SPOUT_ID, SPOUT_STREAM_ID, MulticastBenchBolt.class);
