...
import org.apache.storm.benchmark.bolt.MulticastThroughputBolt;
import org.apache.storm.benchmark.spout.MulticastKafkaSpout;
 ...
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelBalancedParitalThroughputTopology MulticastThroughputTopology ordersTopic6 31 1 480 2 netty 1000
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelBalancedParitalThroughputTopology MulticastThroughputTopology ordersTopic 7 1 28 2 rdma 1000
 */
public class MulticastModelBalancedParitalThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOUT_ID, new MulticastKafkaSpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER, topic)), spoutInstancesNum);
        graph = builder.constructionBalancedPartialMulticast(boltInstancesNum, numworkers - 1, maxOutDegree, KAFKA_SPOUT_ID, SPOUT_STREAM_ID, BROADCAST_STREAM_ID, MulticastThroughputBolt.class);
