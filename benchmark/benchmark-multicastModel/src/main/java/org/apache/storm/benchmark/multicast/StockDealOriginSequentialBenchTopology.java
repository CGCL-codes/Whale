 ...
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.StockDealOriginSequentialBenchTopology MulticastBenchTopology ordersTopic 26 1 25 100000 rdma 1
 */
public class StockDealOriginSequentialBenchTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        graph = builder.constructionSequential(boltInstancesNum, numworkers - 1,
                KAFKA_SPOUT_ID, SPOUT_STREAM_ID, StockDealBenchBolt.class);
