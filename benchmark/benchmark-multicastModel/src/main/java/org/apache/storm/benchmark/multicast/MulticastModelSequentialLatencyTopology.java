 ...
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelSequentialLatencyTopology MulticastLatencyTopology ordersTopic6 31 1 480 2 netty 1000
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelSequentialLatencyTopology MulticastLatencyTopology ordersTopic 7 1 28 2 rdma 1000
 */
public class MulticastModelSequentialLatencyTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        graph = builder.constructionSequential(boltInstancesNum, numworkers - 1, KAFKA_SPOUT_ID, SPOUT_STREAM_ID, MulticastLatencyBolt.class);
