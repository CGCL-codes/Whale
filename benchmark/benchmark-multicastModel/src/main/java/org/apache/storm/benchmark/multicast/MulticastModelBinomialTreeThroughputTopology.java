 ...
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelBinomialTreeThroughputTopology MulticastThroughputTopology ordersTopic6 31 1 480 2 netty 1000
 * storm jar benchmark-multicastModel-2.0.0-SNAPSHOT.jar org.apache.storm.benchmark.multicast.MulticastModelBinomialTreeThroughputTopology MulticastThroughputTopology ordersTopic 7 1 28 2 rdma 1000
 */
public class MulticastModelBinomialTreeThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        graph = builder.constructionBinomialTree(boltInstancesNum, numworkers - 1, KAFKA_SPOUT_ID, SPOUT_STREAM_ID, BROADCAST_STREAM_ID, MulticastThroughputBolt.class);
