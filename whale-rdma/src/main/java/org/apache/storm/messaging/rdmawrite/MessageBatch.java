 ...
 */
package org.apache.storm.messaging.rdmawrite;
...
public class MessageBatch {
    ...
    public ChannelBuffer buffer() throws Exception {
        ...
        ChannelBufferOutputStream bout = new ChannelBufferOutputStream(ChannelBuffers.directBuffer(encoded_length+4));
    ...
    private void writeWorkerMessage(ChannelBufferOutputStream bout, WorkerMessage message) throws Exception {
        int payload_len =  message.message().length;
