...
public class Config extends HashMap<String, Object> {
    ...
    /**
     * Whale-Multicast Source Emit StreamID
     */
    @isString
    public static final String TOPOLOGY_MULTICAST_SOURCE_STREMAID = "topology.multicast.source.streamid";

    /**
     * Whale-Multicast Broadcastbolt Emit StreamID
     */
    @isString
    public static final String TOPOLOGY_MULTICAST_BROADCASTBOLT_STREMAID = "topology.multicast.broadcastbolt.streamid";

    /**
     * STORM Message RDMA Transport SEND LIMIT TIME
     */
    @isInteger
    @isPositiveNumber
    public static final String STORM_MESSAGING_RDMA_SEND_LIMIT_TIME= "storm.messaging.rdma.limit_time";

    /**
     * If the RDMA messaging layer is busy, the RDMA client will try to batch message as more as possible up to the size of STORM_NETTY_MESSAGE_BATCH_SIZE bytes
     */
    @isInteger
    @isPositiveNumber
    public static final String STORM_RDMA_MESSAGE_BATCH_SIZE = "storm.messaging.rdma.transfer.batch.size";

    /**
     * Storm Worker-oriented One-to-Many Partition}
     */
    @isBoolean
    @NotNull
    public static final String STORM_WORK_ORIENTED_PARTITION = "storm.messaging.work.oriented.partition";
     ...
     */
    @isBoolean
    public static final String TOPOLOGY_NONBLOCKMULIT_ENABLE = "topology.nonblockmulti.enable";
